...
{
    public class EmailNotifier : IFeeNotifier
    {
        private readonly ApplicationContext _context;
        public EmailNotifier(ApplicationContext context)
        {
            _context = context;
        }
        public string Notify(int studentId)
        {
            ...
            {
                return $"Sending Email to {student.Email}: Dear {student.FirstName} {student.LastName}, your pending fee is {student.FeePending:C}. Please pay at the earliest.";
            }
